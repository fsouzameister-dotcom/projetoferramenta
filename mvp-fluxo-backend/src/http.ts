...
export const ERROR_CODES = {
  ...
  clients: {
    ...
    CLIENT_PHONES_LIST_FAILED: "CLIENT_PHONES_LIST_FAILED",
    CLIENT_PHONE_CREATE_FAILED: "CLIENT_PHONE_CREATE_FAILED",
    CLIENT_PHONE_UPDATE_FAILED: "CLIENT_PHONE_UPDATE_FAILED",
    CLIENT_PHONE_NOT_FOUND: "CLIENT_PHONE_NOT_FOUND",
    CLIENT_DELETE_FAILED: "CLIENT_DELETE_FAILED",
    CLIENT_PHONE_DELETE_FAILED: "CLIENT_PHONE_DELETE_FAILED",
    CLIENT_DELETE_BLOCKED: "CLIENT_DELETE_BLOCKED",
  },
  users: {
  ...
  inbound: {
    INBOUND_ROUTES_LIST_FAILED: "INBOUND_ROUTES_LIST_FAILED",
    INBOUND_ROUTE_CREATE_FAILED: "INBOUND_ROUTE_CREATE_FAILED",
    INBOUND_ROUTE_UPDATE_FAILED: "INBOUND_ROUTE_UPDATE_FAILED",
    INBOUND_ROUTE_DELETE_FAILED: "INBOUND_ROUTE_DELETE_FAILED",
    INBOUND_ROUTE_NOT_FOUND: "INBOUND_ROUTE_NOT_FOUND",
    INBOUND_ROUTE_DUPLICATE: "INBOUND_ROUTE_DUPLICATE",
    INBOUND_ROUTE_INVALID_SOURCE: "INBOUND_ROUTE_INVALID_SOURCE",
  },
  whatsapp: {
